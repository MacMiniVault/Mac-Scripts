...
# VERSION 2.0 RELEASE DATE AUG 27, 2015     #
# DESC:  THIS SCRIPT SETS UP WORDPRESS ON   #
#        A OS X 10.10 MACHINE W/ SERVER.APP #
#        AND MYSQL INSTALLED                #
#############################################
#REQUIREMENTS:
#  OS X 10.10
...
if [[  $(sw_vers -productVersion | grep '10.10') && $(serverinfo --configured | grep 'has') && $(which mysql) ]]
then
echo "Congratulations, you are running OS X 10.10.x and have Server.app and MySQL installed...."
...
echo "ERROR: YOU ARE NOT RUNNING OS X 10.10 OR YOU DO NOT HAVE SERVER.APP OR MySQL INSTALLED"
exit 1
fi
