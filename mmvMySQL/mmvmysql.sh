...
curl -# -Lo ~/Downloads/MySQL.dmg http://dev.mysql.com/get/Downloads/MySQL-5.6/mysql-5.6.23-osx10.9-x86_64.dmg
...
cd /Volumes/mysql-5.6.23-osx10.8-x86_64/
echo "..."
echo "..."
echo "Installing MySQL, administrator password required ..."
sudo installer -applyChoiceChangesXML ~/Downloads/MySQL-install.plist -pkg mysql-5.6.23-osx10.8-x86_64.pkg -target /
echo "..."
echo "..."
...
cd ~/
hdiutil detach -quiet /Volumes/mysql-5.6.23-osx10.8-x86_64/
sleep 2
