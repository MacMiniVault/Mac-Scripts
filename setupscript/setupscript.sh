...
if [[  $(sw_vers -productVersion | awk -F '.' '{print $1 "." $2}' | grep -E '10.[7-9]|1[0-9]|2[67].[0-9]') ]]
then
...
if [[  $(sw_vers -productVersion | awk -F '.' '{print $1 "." $2}' | grep -E '10.1[0-5]|1[1-5].[0-9]|2[67].[0-9]') ]]
then
...
if [[  $(sw_vers -productVersion | awk -F '.' '{print $1 "." $2}' | grep -E '1[1-5].[0-9]|2[67].[0-9]') ]]
then
